      ...
      <AnimatePresence>
        {hamburgerOpen && (
          <motion.ul
            ...
            animate="visible"
            exit="hidden"
            className="bg-background2 border-t border-b border-primary dark:border-dark-primary w-screen z-40 dark:bg-dark-background2 dark:text-dark-text flex flex-col text-text fixed top-20 max-[400px]:top-14 px-10 py-10 "
          >
            {NavTags.map((item) => (
              <HamburgerNav
