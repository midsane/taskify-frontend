...
export default function Profile() {
  ...
  return (
    <div className="h-screen bg-background lg:h-screen gap-8 max-[475px]:gap-1 flex flex-col justify-center items-center w-full pt-20 ">
      <section className="h-[10%] py-10 max-[475px]:py-24 w-[80%] gap-5 flex flex-col justify-center items-center">
